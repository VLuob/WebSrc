<template>
	<div id="streamProxyList">
		<el-container>
			...
			<el-main>
				<div
					style="background-color: #FFFFFF; margin-bottom: 1rem; position: relative; padding: 0.5rem; text-align: left;"
				>
						...
						<template slot-scope="scope">
							<el-button-group>
								...
								<el-button
									...
									icon="el-icon-delete"
									type="danger"
									@click="deleteStreamProxy(scope.row)"
								>删除</el-button>
							</el-button-group>
						</template>
					</el-table-column>
